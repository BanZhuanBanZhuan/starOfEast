...
public class ControllerAspect {
    ...
    @Around("execution(public * com.gateway.controller.*.*(..))")
    ...
    private String handleException(Exception e) throws GatewayException {
        if(e instanceof GatewayException) {
            GatewayException ae = ((GatewayException) e);
