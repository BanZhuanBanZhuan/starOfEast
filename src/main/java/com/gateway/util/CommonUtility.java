...
public class CommonUtility {
    ...
    static public JSONObject convertBeanToJsonObject(Object bean) throws GatewayException {
        if (bean == null) {
    ...
    static public JSONArray convertBeanToJsonArray(Object bean) throws GatewayException {
        if (bean == null) {
        ...
        try {
            ...
            throw new GatewayException(-1, "服务器内部错误", e);
        }
    }


    public static String constructResultJson(String code, Object message) throws GatewayException {
